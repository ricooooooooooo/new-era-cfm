  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-[#080909] px-4 py-10 sm:px-6 lg:px-10">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-20 h-72 w-72 -translate-x-1/2 rounded-full bg-amber-600/10 blur-[120px]" />
      ...
      <div className="relative mx-auto flex max-w-4xl items-center justify-center">
        <div className="w-full overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.035] shadow-[0_30px_100px_rgba(0,0,0,0.55)] backdrop-blur-xl">
          <div className="border-b border-white/10 bg-gradient-to-r from-amber-500/10 via-white/[0.025] to-blue-500/10 px-6 py-5 sm:px-8">
          ...
          <div className="px-6 py-10 sm:px-10 sm:py-14">
            <div className="mx-auto max-w-2xl text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] text-3xl shadow-[0_0_35px_rgba(212,175,55,0.15)]">
                🚧
              </div>
              ...
              <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-white/10 bg-black/20 p-5 sm:p-6">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  {features.map((feature) => (
                    ...
                    >
                      <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-amber-400/20 bg-amber-400/10 text-xs font-black text-amber-200">
                        ✓
                      </div>
            ...
            <div className="mx-auto mt-8 max-w-2xl rounded-2xl border border-amber-400/15 bg-amber-400/[0.06] px-5 py-4 text-center">
