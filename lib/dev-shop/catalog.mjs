...
export const PAID_PRODUCTS = Object.freeze([
  {
    ...
    limit: 1,
    scope: "team_season",
    description: "Use your team’s one Star Dev purchase on an eligible player.",
    capText: "1 per team • resets each season",
  ...
  },
  {
    ...
    limit: 1,
    scope: "team_season",
    description: "Use your team’s one Superstar Dev purchase on an eligible player.",
    capText: "1 per team • resets each season",
    approvalText: "Commissioner fulfillment required",
  },
  {
    ...
    limit: 1,
    scope: "team_season",
    description: "Use your team’s one X-Factor Dev purchase on an eligible player.",
    capText: "1 per team • resets each season",
    approvalText: "Commissioner fulfillment required",
  },
  {
    ...
    capText: "6 per player / season • attribute cap 98",
    approvalText: null,
  },
  {
